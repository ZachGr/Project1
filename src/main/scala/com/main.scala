...
object main {
  ...
  def main(args: Array[String]): Unit = {
    ...
    spark.sql("SELECT SUM(_c5) AS Damages, COUNT(_c4) AS TS, ROUND(AVG(_c5),1) as avg FROM hdfsdamage WHERE _c4 = '"+catTest+"'").show()
      /*spark.sql("SELECT SUM(_c4) AS Deaths, COUNT(_c3) AS TS, ROUND(AVG(_c4),1) as avg FROM death WHERE _c3 = 'TS'").show()
      spark.sql("SELECT SUM(_c4) AS Deaths, COUNT(_c3) AS Cat1, ROUND(AVG(_c4),1) as avg FROM death WHERE _c3 = 1").show()
      spark.sql("SELECT SUM(_c4) AS Deaths, COUNT(_c3) AS Cat2, ROUND(AVG(_c4),1) as avg FROM death WHERE _c3 = 2").show()
      spark.sql("SELECT SUM(_c4) AS Deaths, COUNT(_c3) AS Cat3, ROUND(AVG(_c4),1) as avg FROM death WHERE _c3 = 3").show()
      spark.sql("SELECT SUM(_c4) AS Deaths, COUNT(_c3) AS Cat4, ROUND(AVG(_c4),1) as avg FROM death WHERE _c3 = 4").show()
      spark.sql("SELECT SUM(_c4) AS Deaths, COUNT(_c3) AS Cat5, ROUND(AVG(_c4),1) as avg FROM death WHERE _c3 = 5").show()
    ...
    def signIn(){
      ...
      try {
        ...
        /*while (account.next) {
          val id = account.getString("id")
          val host = account.getString("username")
          val user = account.getString("psw")
          val acounttest = (id, host, user)*/
